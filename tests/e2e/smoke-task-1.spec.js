...
test('functional: button colors are correct', async ({ page }) => {
  ...
  // Check increment button is green-ish (#2d6a4f = rgb(45, 106, 79))
  ...
  // Check decrement button is red-ish (#c0392b = rgb(192, 57, 43))
  ...
  // Check reset button is gray-ish (#6c757d = rgb(108, 117, 125))
